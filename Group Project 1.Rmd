...
#bianca: QUestion, why is it (1 + mathknow|schoolid) rather than (0 + mathknow|schoolid)?
...
Why housepov bad idea? There is only one data point per school, so we cannot have a random slope since we can't even calculate a slope.
