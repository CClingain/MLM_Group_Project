...
```
The uncorrelated ses random slope at a school level is insignifcant with a p value of .433
...
```
insignificant with a pvalue of 1.0
...
```
is signifcant with a p value of .03
...
```
insignificant with a pvalue of .394
...
```
significant with a pvalue of .0025
...
```
Very close to significance but not quite there with a pvalue of .0766
...
\textbf{Answer:} Mathmatically we can with a range of 384.427 to 424.653 though we can do this it doesn't make much sense due to the correlated nature of this with the minority variable the values wouldn't hold much meaning and are easily mis interpretted
