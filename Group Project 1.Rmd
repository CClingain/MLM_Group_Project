...
To deal with the missing data, we removed those students. This left us with a sample of 1081 students. 
...
```{r}
model4_red <- lmer(Math1~housepov+mathknow+yearstea+mathprep+sex+minority+
                     ses+(1|schoolid/classid),data=classroom_red)
...
$Math1st_{ijk} = \beta_{0ijk} + \zeta_{k} + \eta_{jk} + \epsilon_{ijk} + \beta_1Housepov_k +\beta_2Mathknow_{jk} + \beta_3YearsTea_{jk} +\beta_4Mathprep_{jk} + \beta_5sex_{ijk} + \beta_6minority_{ijk} + \beta_7ses_{ijk}$
