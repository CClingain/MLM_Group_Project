...
plot(classroom2$zeta0c,classroom2$zeta1c, main = "Zeta0 vs. Zeta1", ylab = "Zeta1",xlab = "Zeta0", pch=19)
 text(classroom2$zeta0c,classroom2$zeta1c, labels = classroom2$schoolid, cex = 0.8, col = 2)
```


##Tracking down outliers

The outliers from the plots above can be tracked down by examining the data points that are a part of the positive trend.
